          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm md:text-base">+1 (212) 696-0824</span>
              </div>
              <div className="flex items-center space-x-2">
                <svg
                  className="w-4 h-4 md:w-5 md:h-5 text-blue-400 shrink-0"
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex space-x-3">
                <a
                  href="#"
                  className="bg-blue-700 hover:bg-blue-700 text-white p-2 rounded transition-colors"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <a
                  href="#"
                  className="bg-blue-700 hover:bg-blue-800 text-white p-2 rounded transition-colors"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
        ...
        <div className="border-t border-gray-700 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2024 IQ ELECTRICAL. All rights reserved. Licensed Master
              Electrician #12345
            </div>
